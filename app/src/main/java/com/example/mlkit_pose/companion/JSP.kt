...
class JSP {
    companion object {
        ...
        fun getSignInURL(
            ...
            val url =
                Jsp_Url + "Sign.jsp?userName=$inputName&userId=$inputId&userPwd=$inputPw&userTeam=$inputTeam&userAge=$inputAge&userGender=$inputGender&userHeight=$inputHeight&userWeight=$inputWeight"
            return url
        }
        ...
        fun getUserPointSet(
            ...
            val url =
                Jsp_Url + "InsertScore.jsp?userId=$inputId&userScore=$points&last_exc=$today&total_exc=$countDays"
            return url
        }
        ...
        fun setUserInfoEdit(
            ...
            val url =
                Jsp_Url + "MypageUpdate.jsp?height=$inputHeight&weight=$inputWeight&team=$inputTeam&userId=$inputId"
            return url
        }
...
//            val url = Jsp_Url+"RoutineInsert.jsp?userId=$inputId&routine_name=$routineName&exc_name=$execName&engexc_name=$engExcName"
            val url =
                Jsp_Url + "insert.jsp?userId=$inputId&routine_name=$routineName&exc_name=$execName&engexc_name=$engExcName"
            return url
        }
        ...
        fun setRoutineInsOne(
            ...
            val url =
                Jsp_Url + "RoutineInsert.jsp?userId=${inputId}&routine_name=${routine_name}&exc_name=${exc_name}&engexc_name=${engexc_name}"
            return url
        }

        fun deleteRoutineExc(inputId: String, routine_name: String, exc_name: String): String {
            val url =
                Jsp_Url + "RoutineExcDelete.jsp?userId=${inputId}&routine_name=${routine_name}&exc_name=${exc_name}"
            return url
        }
