...
class JSP {
    companion object {
        ...
        fun getUserPointSet(inputId:String, points:String, today:String, countDays:String):String{
            val url = Jsp_Url+"InsertScore.jsp?userId=$inputId&userScore=$points&last_exc=$today&total_exc=$countDays"
            return url
        }
